...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AirtimeApplication.notification'
        db.delete_column(u'gopher_airtimeapplication', 'notification')

        # Deleting field 'AirtimeApplication.sms'
        db.delete_column(u'gopher_airtimeapplication', 'sms')

        # Adding field 'AirtimeApplication.notification_sms'
        db.add_column(u'gopher_airtimeapplication', 'notification_sms',
                      self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AirtimeApplication.notification'
        db.add_column(u'gopher_airtimeapplication', 'notification',
                      self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'AirtimeApplication.notification_sms'
        db.delete_column(u'gopher_airtimeapplication', 'notification_sms')
    ...
    models = {
        u'gopher.airtimeapplication': {
            ...
            'notification_sms': ('django.db.models.fields.CharField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'}),
        ...
        u'gopher.sendairtime': {
            ...
            'amount': ('django.db.models.fields.IntegerField', [], {}),
            'app_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'app_id'", 'to': u"orm['gopher.AirtimeApplication']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'msisdn': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'product_key': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
