...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'quiz_question', 'question', self.gf('django.db.models.fields.CharField')(max_length=163))

        # Changing field 'Answer.answer'
        db.alter_column(u'quiz_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=156))

        # Changing field 'Answer.response'
        db.alter_column(u'quiz_answer', 'response', self.gf('django.db.models.fields.CharField')(max_length=156))

    def backwards(self, orm):

        # Changing field 'Question.question'
        db.alter_column(u'quiz_question', 'question', self.gf('django.db.models.fields.CharField')(max_length=180))

        # Changing field 'Answer.answer'
        db.alter_column(u'quiz_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=160))

        # Changing field 'Answer.response'
        db.alter_column(u'quiz_answer', 'response', self.gf('django.db.models.fields.CharField')(max_length=160))
