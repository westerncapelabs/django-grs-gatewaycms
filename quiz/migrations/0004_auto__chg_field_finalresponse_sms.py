...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FinalResponse.sms'
        db.alter_column(u'quiz_finalresponse', 'sms', self.gf('django.db.models.fields.CharField')(max_length=320))

    def backwards(self, orm):

        # Changing field 'FinalResponse.sms'
        db.alter_column(u'quiz_finalresponse', 'sms', self.gf('django.db.models.fields.CharField')(max_length=160))
