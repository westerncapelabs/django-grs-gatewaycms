...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quiz.updated_by'
        db.alter_column(u'quiz_quiz', 'updated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Quiz.updated_by'
        db.alter_column(u'quiz_quiz', 'updated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
